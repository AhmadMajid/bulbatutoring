...
ActiveRecord::Schema[7.0].define(version: 2023_04_04_090650) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.index ["tutor_id", "user_id"], name: "index_favorites_on_tutor_id_and_user_id", unique: true
    t.index ["tutor_id"], name: "index_favorites_on_tutor_id"
